...
;============================================================DESCRIPTION=======================================================================
;----------------------------------------------------------------------------------------------------------------------------------------------
;			This function implements output to stdout with format string. All numbers is 4 byte.
;			All formats:
;				%% - print percent
;				%d - print 10base number
;				%x - print 16base number
;				%o - print 8base  number
;				%b - print 2base  number
;				%s - print string
;	 			%c - print char
;				%u - print unsigned
;----------------------------------------------------------------------------------------------------------------------------------------------
...
percentHandler:
	...
	not_percent:
		; sub al, 'b' 								;|calculations for jump table
		cmp al, 'b' 									;|check extreme cases
		jb SWITCH_END	 							;|
		cmp al, 'z'									;|
		ja SWITCH_END	 							;|

		jmp [JMP_TABLE + (rax - 'b') * 8] 					;JUMP!!! (to case)
